		...
		<Stack
			...
			<Stack
				...
				<Stack rowGap={"1rem"} padding={"1rem"}>
					...
					<Typography sx={labelStyles}>
						martinsjohnokaformjo@gmail.com
					</Typography>
					<Typography sx={labelStyles}>2348161384255</Typography>
				</Stack>
				...
				<Stack rowGap={"1rem"} padding={"1rem"}>
					...
					<Typography
						...
						Save #5000 with App New User Only
					</Typography>
			...
			<Stack alignSelf={"center"}>
				<Typography color={"GrayText"}>
					&copy; AmayoMJO Store {new Date().getFullYear()}. All right reserved
				</Typography>
			</Stack>
		</Stack>
	);
