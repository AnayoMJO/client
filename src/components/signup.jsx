...
export const Signup = () => {
	...
	useEffect(() => {
		if (status === "fullfilled") {
			toast.success(
				"Welcome! Verify your email to start shopping on AnayoMJO e-commerce Store."
			);
			reset();
		}
		return () => {
				...
				<Stack
					...
					<Stack rowGap={".4rem"}>
						...
						<Typography
							...
							variant="body2"
							gutterBottom>
							- Shop Anything and Pay With Crypto on AnayoMJO E-COMMERCE Store
						</Typography>
					</Stack>
				</Stack>
				<form
